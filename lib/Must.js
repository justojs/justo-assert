...
class Must extends Wrapper {
   ...
   */
  match(...args) {
    mustMatch.call(mustMatch, this.value, ...args);
  }
}
...
class MustNot extends Wrapper {
   ...
   */
  match(...args) {
    mustNotMatch.call(mustNotMatch, this.value, ...args);
  }
}
...
class MustAll extends Wrapper {
  have(...args) {
    mustAllHave.call(mustAllHave, this.value, ...args);
  }
}
...
class MustNotAll extends Wrapper {
  have(...args) {
    mustNotAllHave.call(mustNotAllHave, this.value, ...args);
  }
}
...
class MustBe extends Wrapper {
   ...
   */
  insideOf(...args) {
    mustBeInsideOf.call(mustBeInsideOf, this.value, ...args);
  }
...
class MustNotBe extends Wrapper {
   ...
   */
  insideOf(...args) {
    mustNotBeInsideOf.call(mustNotBeInsideOf, this.value, ...args);
  }
