describe("must<number>", function() {
  ...
  describe("#must.be.instanceOf()", function() {
    it("be.instanceOf('Number') - pass", function() {
  ...
  describe("#must.not.be.instanceOf()", function() {
    it("not.be.instanceOf('Number') - fail", function() {
      (function() {
  ...
  describe("#must.all.have()", function() {
    it("all.have() - fail", function() {
      (function() {
        x.must.all.have(["x", "y"]);
      }).should.throwError(Error, {name: "AssertionError", message: "'1' must be a list/array."});
    });
  });
