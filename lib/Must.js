...
class MustBe extends Wrapper {
  ...
  /**
   * Check whether the wrapped value is similar to another.
   */
  similarTo(...args) {
    assert.mustBeSimilarTo.call(assert.mustBeSimilarTo, this.value, ...args);
  }
...
class MustNotBe extends Wrapper {
  ...
  /**
   * Check whether the wrapped value isn't similar to another.
   */
  similarTo(...args) {
    assert.mustNotBeSimilarTo.call(assert.mustNotBeSimilarTo, this.value, ...args);
  }
